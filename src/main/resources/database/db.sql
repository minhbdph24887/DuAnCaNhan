...
alter table OrderDetail add foreign key (ProductDetailID) references ProductDetails(ID)
go

--Bảng PrductDetails Nối Với Bảng Categories
alter table ProductDetails add foreign key (CategoryID) references Categories(ID)
go

--Bảng ProductDetails Nối Với Bảng Products
alter table ProductDetails add foreign key (ProductID) references Products(ID)
go

--Bảng ProductDetails Nối Với Bảng Sizes
alter table ProductDetails add foreign key (SizeID) references Sizes(ID)
go

--Bảng ProductDetails Nối Với Bảng Colors
alter table ProductDetails add foreign key (ColorID) references Colors(ID)
go

--Bảng ProductDetails Nối Với Bảng Producers
alter table ProductDetails add foreign key (ProducerID) references Producers(ID)
go
...
alter table PromotionsProduct add foreign key (ProductDetailID) references ProductDetails(ID)
go
