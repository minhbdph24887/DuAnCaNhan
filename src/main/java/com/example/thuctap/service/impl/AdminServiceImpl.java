...
public class AdminServiceImpl implements AdminService {
    ...
    public List<Category> viewCategory() {
        return categoryRepository.viewCBB();
    }
    ...
    @Override
    public Page<PromotionsProduct> getAllPromotionsProducts(Pageable pageable, Long idPromotion) {
        return promotionsProductRepository.getAllPromotionsProduct(pageable, idPromotion);
    }
    ...
    public PromotionsProduct addPromotionsProduct(PromotionsProduct promotionsProduct) {
        PromotionsProduct promotionsProduct1 = PromotionsProduct.builder()
                .promotion(promotionsProduct.getPromotion())
                .productDetail(promotionsProduct.getProductDetail())
                .status(1)
                .build();
