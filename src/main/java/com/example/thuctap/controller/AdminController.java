...
public class AdminController {
    ...
    @RequestMapping(value = "/admin/home/index", method = RequestMethod.GET)
    ...
    public String viewAccount(Model model, @RequestParam(defaultValue = "0") int page) {
        ...
        return "admin/account/viewAccount";
    }
    ...
    public String detailAccount(Model model, @PathVariable("username") String username) {
        ...
        return "admin/account/view-update";
    }
    ...
    public String viewAuthority(Model model, @RequestParam(defaultValue = "0") int page) {
        Page<Authority> itemAuthorities = service.getAllAuthorities(PageRequest.of(page, 5));
        model.addAttribute("listAuthority", itemAuthorities);
        model.addAttribute("currentPage", page);
        return "admin/authority/viewAuthority";
    }
    ...
    public String detailAuthority(Model model, @PathVariable("idAuthorities") Long idAuthorities) {
        Authority detailAuthorities = service.detailAuthorities(idAuthorities);
        listAccount = service.getAllAccounts();
        listRole = service.getAllRoles();
        model.addAttribute("detailAuthority", detailAuthorities);
        model.addAttribute("listAccount", listAccount);
        model.addAttribute("listRole", listRole);
        return "admin/authority/view-update";
    }
    ...
    public String viewProductDetail(Model model, @RequestParam(defaultValue = "0") int page) {
        Page<ProductDetail> itemProductDetails = service.getAllProductDetails(PageRequest.of(page, 5));
        model.addAttribute("listProductDetail", itemProductDetails);
        model.addAttribute("currentPage", page);
    ...
    public String viewAddProductDetail(Model model) {
        ...
        model.addAttribute("productItems", productDetail);
    ...
    public String viewAddVoucher(Model model) {
        ...
        listProductDetails = service.cbbProductDetails();
    ...
    public String detailPromotionsProduct(Model model, @PathVariable("idPromotion") Long idPromotion, @RequestParam(defaultValue = "0") int page) {
        Promotion promotion = service.detailPromotion(idPromotion);
        Page<PromotionsProduct> itemsPromotionsProduct = service.getAllPromotionsProducts(PageRequest.of(page, 5), promotion.getIdPromotion());
        model.addAttribute("detailPromotion", promotion);
        model.addAttribute("listPromotionsProduct", itemsPromotionsProduct);
        model.addAttribute("currentPage", page);
    ...
    public String updatePromotionsProduct(Promotion promotions) {
        service.updatePromotion(promotions);
        return "redirect:/admin/voucher";
    }
